...
let routes = [
	...
	},
	{
		...
		meta: {
			title: 'New Product',
			sidebarMap: ['product', 'new-product'],
	...
	{
		path: '/products/new-option/:id',
		name: 'New option',
		layout: "dashboard",
		meta: {
			title: 'New option',
			sidebarMap: ['option', 'new-option'],
			breadcrumbs: ['Options', 'New Option'],
		},
		component: () => import('../views/Products/NewOption.vue'),
	},
	{
